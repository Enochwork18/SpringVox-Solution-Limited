        ...
        >
          ...
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <div className="flex items-center gap-1 pl-2">
              ...
              <span className="w-1.5 h-1.5 rounded-full bg-[#0299b1] animate-pulse" style={{ animationDelay: "0.2s" }} />
              <span className="w-1.5 h-1.5 rounded-full bg-[#0299b1] animate-pulse" style={{ animationDelay: "0.4s" }} />
            </div>
          </div>
