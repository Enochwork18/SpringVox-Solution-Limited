...
export const IconCode = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconCube = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5" /><line x1="12" y1="22" x2="12" y2="12" /><line x1="2" y1="8.5" x2="22" y2="8.5" /><line x1="12" y1="12" x2="2" y2="15.5" /><line x1="12" y1="12" x2="22" y2="15.5" />
  </svg>
);
...
export const IconBrain = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 2.58-3.04Z" /><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-2.58-3.04Z" />
  </svg>
);
...
export const IconSparkle = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 3a6 6 0 0 0 9 9 6 6 0 0 0-9 9 6 6 0 0 0-9-9 6 6 0 0 0 9-9Z" /><path d="M6.5 14.5a4 4 0 0 0 3 3 4 4 0 0 0-3 3 4 4 0 0 0-3-3 4 4 0 0 0 3-3Z" />
  </svg>
);
...
export const IconQuote = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M10 11H6a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3c0 2.5-1.5 4.76-4 6a1 1 0 0 1-1.42-.45 1 1 0 0 1 .45-1.33A3.93 3.93 0 0 0 9 11.5V11z" /><path d="M19 11h-4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3c0 2.5-1.5 4.76-4 6a1 1 0 0 1-1.42-.45 1 1 0 0 1 .45-1.33A3.93 3.93 0 0 0 18 11.5V11z" />
  </svg>
);
...
export const IconFinance = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /><circle cx="12" cy="12" r="10" />
  </svg>
);
...
export const IconTelecom = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M5 12h14" /><path d="M12 5v14" /><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="3" />
  </svg>
);

export const IconLogistics = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="5" cy="17" r="2" /><circle cx="17" cy="17" r="2" /><path d="M7 18h8" /><path d="M17 17V5h-4l-4 4H6l-1 4h4" /><path d="M14 9V5" />
  </svg>
);
...
export const IconEducation = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M2 7l10-5 10 5-10 5-10-5z" /><path d="M6 18v-8l6-3" /><path d="M18 18v-8" /><path d="M2 17v3l10 3 10-3v-3" />
  </svg>
);
...
export const IconEnterprise = ({ className, size }: IconProps) => (
  <svg {...sizeAttr(size)} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect x="2" y="8" width="4" height="14" /><rect x="10" y="2" width="4" height="20" /><rect x="18" y="5" width="4" height="17" /><circle cx="4" cy="4" r="1" /><circle cx="12" cy="7" r="1" /><circle cx="20" cy="2" r="1" />
  </svg>
);
