      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mt-8">
        <div className="space-y-4">
          <div className="p-6 rounded-2xl bg-dark-card border border-white/5">
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3">Our Mission</h3>
            <p className="text-sm text-muted leading-relaxed">{company.mission}</p>
          </div>
          <div className="p-6 rounded-2xl bg-dark-card border border-white/5">
            <h3 className="text-base sm:text-lg font-semibold text-white mb-3">Our Vision</h3>
            <p className="text-sm text-muted leading-relaxed">{company.vision}</p>
          </div>
        </div>

        <div>
          <h3 className="text-base sm:text-lg font-semibold text-white mb-6">Our Core Values</h3>
          <div className="space-y-4">
            {values.map((v, i) => (
              <motion.div
                key={v.label}
          ...
          >
            <p className="text-sm text-muted leading-relaxed">
              From our flagship <strong className="text-white">ReKallIQ</strong> knowledge AI platform to custom enterprise builds, we serve startups, growing businesses, and large organisations across Africa and beyond. We believe great technology should be accessible, secure, and built to last.
            </p>
            <p className="text-sm text-muted leading-relaxed mt-3">
              Since {company.founded}, we have been at the forefront of digital transformation. Our products include ReKallIQ - an enterprise AI knowledge platform - and we continue to build solutions across cybersecurity, VoIP, and enterprise automation.
            </p>
          </motion.div>
        </div>
      </div>
