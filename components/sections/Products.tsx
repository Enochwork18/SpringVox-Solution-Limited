    ...
    >
      <div className="space-y-6">
        ...
        <p className="text-sm text-muted leading-relaxed">
          ReKallIQ is SpringVox&apos;s flagship AI platform that transforms your internal
          documents, policies, and institutional knowledge into a secure, always-available
          AI assistant. Powered by private RAG (Retrieval-Augmented Generation), your team
          gets instant, source-cited answers \u2014 without your data ever touching a public AI model.
        </p>

        <div className="space-y-2.5">
          {rekalliqFeatures.map((feat) => (
            <div key={feat} className="flex items-start gap-2.5 text-sm text-muted">
        ...
        <p className="text-xs text-muted/70 flex items-center gap-1.5">
          <span className="flex-shrink-0 w-4 h-4 rounded-full bg-[#0299b1]/20 flex items-center justify-center mt-0.5"><svg className="w-2.5 h-2.5 text-[#0299b1]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg></span>
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 40px rgba(2, 153, 177, 0.08), 0 0 80px rgba(2, 153, 177, 0.03)",
          }}
        >
          <div className="p-4 sm:p-5 border-b border-white/5">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-semibold text-white">SpringVox Knowledge AI</p>
                <p className="text-[10px] text-muted">Workspace: Your Organisation</p>
              </div>
          ...
          <div className="p-4 sm:p-5 space-y-4">
            ...
            <div className="flex justify-start">
              <div className="max-w-[85%] p-3 rounded-2xl rounded-bl-sm bg-white/5 border border-white/5">
                <p className="text-xs text-white/90 leading-relaxed">
                  According to your HR Policy document, employees are entitled to 10 sick days per year. Unused days do not roll over but are reviewed annually.
                </p>
            ...
            <div className="flex items-center gap-1 pl-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#0299b1] animate-bounce" style={{ animationDelay: "0ms" }} />
              <span className="w-1.5 h-1.5 rounded-full bg-[#0299b1] animate-bounce" style={{ animationDelay: "150ms" }} />
              <span className="w-1.5 h-1.5 rounded-full bg-[#0299b1] animate-bounce" style={{ animationDelay: "300ms" }} />
            </div>
          </div>

          <div className="px-4 sm:px-5 py-2.5 border-t border-white/5 text-center">
            <span className="text-[10px] text-muted/50">Powered by ReKallIQ</span>
          </div>
        </div>
      </div>
    </motion.div>
      ...
      >
        <div className="relative">
          <div className="w-16 h-16 rounded-full bg-[#0299b1]/10 flex items-center justify-center">
            <svg className="w-8 h-8 text-[#0299b1]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div>
          ...
          <p className="text-sm text-muted leading-relaxed">
            Our team is finalising the next addition to the SpringVox
            product suite. Stay tuned \u2014 or get early access by
