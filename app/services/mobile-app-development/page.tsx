...
const data = {
  ...
  tagline: 'Native and cross-platform mobile apps for iOS and Android that delight users.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83D\uDCF1', label: 'Businesses', description: 'Needing a customer-facing mobile app.' },
    { icon: '\uD83D\uDC77\u200D\u2642\uFE0F', label: 'Field Teams', description: 'Enterprise workers needing mobile tools on the go.' },
    { icon: '\uD83D\uDE80', label: 'Startups', description: 'Building mobile-first products and MVPs.' },
  ],
  differentiators: [
