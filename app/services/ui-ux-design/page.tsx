...
const data = {
  name: 'UI/UX Design',
  tagline: 'User research, wireframing, prototyping, and pixel-perfect design systems that convert.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83D\uDEE0\uFE0F', label: 'Product Teams', description: 'Building customer-facing applications.' },
    { icon: '\uD83C\uDFED', label: 'Enterprises', description: 'Modernising internal tooling and legacy interfaces.' },
    { icon: '\uD83D\uDE80', label: 'Startups', description: 'Needing a polished MVP design before development.' },
  ],
  differentiators: [
