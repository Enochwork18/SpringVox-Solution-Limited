  ...
  forWhom: [
    {
      ...
      description:
        "Outgrowing off-the-shelf software and need custom workflows.",
    },
    {
      icon: "\uD83C\uDFED",
      label: "Enterprises",
      description:
        "Need bespoke internal tools and mission-critical platforms.",
    },
    {
      icon: "\uD83D\uDE80",
      label: "Startups",
      description:
        "Building their core product from scratch with expert engineering.",
    },
  ],
  differentiators: [
