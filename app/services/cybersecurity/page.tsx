...
const data = {
  name: 'Cybersecurity',
  tagline: 'End-to-end security architecture, vulnerability assessments, and continuous threat monitoring.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83C\uDFE6', label: 'Fintechs & Banks', description: 'Subject to CBN/PCI-DSS regulatory requirements.' },
    { icon: '\uD83C\uDFE5', label: 'Healthcare Providers', description: 'Managing sensitive patient data.' },
    { icon: '\uD83C\uDF10', label: 'Remote Enterprises', description: 'With distributed workforces needing secure access.' },
  ],
  differentiators: [
