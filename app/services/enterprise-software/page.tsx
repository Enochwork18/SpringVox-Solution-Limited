...
const data = {
  ...
  tagline: 'Seamlessly connect your ERP, CRM, HR, and finance systems into a unified data ecosystem.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83C\uDFED', label: 'Enterprises', description: 'With fragmented software stacks across departments.' },
    { icon: '\uD83D\uDCCB', label: 'Finance Teams', description: 'Tired of manual data transfers between systems.' },
    { icon: '\uD83D\uDEE0\uFE0F', label: 'Operations Teams', description: 'Needing a unified view of business data.' },
  ],
  differentiators: [
