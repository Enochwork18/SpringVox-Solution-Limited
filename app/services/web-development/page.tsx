  ...
  forWhom: [
    {
      icon: "\uD83C\uDF10",
      label: "Businesses",
      description: "Needing a strong online presence and brand site.",
    },
    {
      icon: "\uD83D\uDEE0\uFE0F",
      label: "Product Teams",
      description: "Launching SaaS platforms and web apps.",
    },
    {
      icon: "\uD83C\uDFDB\uFE0F",
      label: "Organisations",
      description: "Modernising legacy web applications.",
    },
  ],
  differentiators: [
