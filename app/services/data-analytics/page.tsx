...
const data = {
  ...
  tagline: 'Turn raw data into actionable insights with dashboards, pipelines, and visualisation tools.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83D\uDCC8', label: 'Finance Teams', description: 'Needing real-time P&L and financial visibility.' },
    { icon: '\uD83D\uDEE0\uFE0F', label: 'Operations Teams', description: 'Tracking performance metrics across departments.' },
    { icon: '\uD83D\uDCBC', label: 'Executives', description: 'Needing board-ready dashboards and strategic insights.' },
  ],
  differentiators: [
