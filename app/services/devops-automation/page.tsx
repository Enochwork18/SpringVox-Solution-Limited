  ...
  forWhom: [
    {
      ...
      description: "With slow or manual deployment processes.",
    },
    {
      icon: "\uD83D\uDE80",
      label: "Scaling Startups",
      description: "Needing to automate their growing infrastructure.",
    },
    {
      icon: "\uD83C\uDFED",
      label: "Enterprises",
      description: "Modernising legacy deployment and operations.",
    },
  ],
  differentiators: [
