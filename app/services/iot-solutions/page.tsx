  ...
  forWhom: [
    {
      ...
      description: "Monitoring equipment health and production lines.",
    },
    {
      icon: "\uD83C\uDFE2",
      label: "Smart-Building Operators",
      description: "Managing energy, security, and facility systems.",
    },
    {
      icon: "\uD83D\uDE9A",
      label: "Logistics Companies",
      description: "Tracking assets and fleet in the field.",
    },
  ],
  differentiators: [
