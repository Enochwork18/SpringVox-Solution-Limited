...
const data = {
  ...
  tagline: 'Scalable, resilient cloud environments on AWS, GCP, or Azure - designed for performance and cost efficiency.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83D\uDEE1\uFE0F', label: 'Businesses Moving Off-Prem', description: 'Transitioning from on-premise servers to cloud.' },
    { icon: '\uD83D\uDE80', label: 'Scaling Startups', description: 'Needing infrastructure that grows with them.' },
    { icon: '\uD83C\uDF0D', label: 'Multi-Cloud Enterprises', description: 'Requiring resilient, distributed architectures.' },
  ],
  differentiators: [
