...
const data = {
  ...
  tagline: 'Smart contracts, tokenisation, and decentralised application development.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83C\uDFE6', label: 'Fintechs', description: 'Exploring tokenised assets and programmable money.' },
    { icon: '\uD83D\uDEE1\uFE0F', label: 'Supply Chains', description: 'Needing immutable audit trails for goods.' },
    { icon: '\uD83C\uDFDB\uFE0F', label: 'Organisations', description: 'Experimenting with decentralised governance models.' },
  ],
  differentiators: [
