...
const data = {
  ...
  tagline: 'Intelligent systems, predictive models, and AI-powered automation that learn and scale with your business.',
  overview: [
  ...
  forWhom: [
    { icon: '\uD83D\uDCCA', label: 'Data-Rich Organisations', description: 'Wanting predictive insight from their operational data.' },
    { icon: '\uD83E\uDD16', label: 'HR & Ops Teams', description: 'Wanting AI assistants for employee self-service.' },
    { icon: '\uD83C\uDF31', label: 'Growing Enterprises', description: 'Wanting to automate decision workflows at scale.' },
  ],
  differentiators: [
