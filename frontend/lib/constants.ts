...
export const LINKS = {
  ...
  companySite: 'https://spring-vox-solution-limited.vercel.app',
}
...
export const products = [
  {
    ...
    features: ['AI-Powered Analytics', 'Workflow Automation', 'Predictive Intelligence', 'Real-time Dashboards'],
  },
  {
    name: 'AegisIDS',
  ...
  },
  {
    ...
    features: ['Omnichannel Support', 'Smart Routing', 'Real-time Analytics', 'CRM Integration'],
  },
  {
    ...
    features: ['Edge Computing', 'Decentralized AI', 'IoT Platforms', 'Quantum Ready'],
  },
]

export const SERVICES = [
  { name: 'Custom Software Development', slug: 'custom-software-development', icon: 'Code', description: 'Bespoke enterprise applications built from the ground up to match your exact operational needs.' },
  { name: 'AI & Machine Learning', slug: 'ai-machine-learning', icon: 'Brain', description: 'Intelligent systems, predictive models, and AI-powered automation that learn and scale with your business.' },
  { name: 'Cybersecurity', slug: 'cybersecurity', icon: 'Shield', description: 'End-to-end security architecture, vulnerability assessments, and continuous threat monitoring.' },
  { name: 'Cloud Infrastructure', slug: 'cloud-infrastructure', icon: 'Cloud', description: 'Scalable, resilient cloud environments on AWS, GCP, or Azure - designed for performance and cost efficiency.' },
  { name: 'Web Development', slug: 'web-development', icon: 'Globe', description: 'Fast, accessible, and visually compelling web applications and marketing sites.' },
  { name: 'Mobile App Development', slug: 'mobile-app-development', icon: 'Smartphone', description: 'Native and cross-platform mobile apps for iOS and Android that delight users.' },
  { name: 'Data Analytics & BI', slug: 'data-analytics', icon: 'BarChart2', description: 'Turn raw data into actionable insights with dashboards, pipelines, and visualisation tools.' },
  { name: 'DevOps & Automation', slug: 'devops-automation', icon: 'GitBranch', description: 'CI/CD pipelines, infrastructure-as-code, and workflow automation that accelerates delivery.' },
  { name: 'Enterprise Software Integration', slug: 'enterprise-software', icon: 'Layers', description: 'Seamlessly connect your ERP, CRM, HR, and finance systems into a unified data ecosystem.' },
  { name: 'IoT Solutions', slug: 'iot-solutions', icon: 'Cpu', description: 'Connected device architectures, sensor networks, and real-time data streams for industrial and smart-building use cases.' },
  { name: 'Blockchain & Web3', slug: 'blockchain-web3', icon: 'Link', description: 'Smart contracts, tokenisation, and decentralised application development.' },
  { name: 'UI/UX Design', slug: 'ui-ux-design', icon: 'Palette', description: 'User research, wireframing, prototyping, and pixel-perfect design systems that convert.' },
]
...
export const industries = [
  { name: 'Finance & Banking', icon: 'finance', description: 'Secure, compliant solutions for financial institutions.' },
  { name: 'Healthcare', icon: 'health', description: 'HIPAA-compliant platforms for healthcare providers.' },
  { name: 'Telecommunications', icon: 'telecom', description: 'Infrastructure and tools for communication providers.' },
  { name: 'Logistics & Supply Chain', icon: 'logistics', description: 'End-to-end visibility and optimization solutions.' },
  { name: 'Government & Public Sector', icon: 'government', description: 'Secure, scalable systems for government agencies.' },
  { name: 'Education & E-Learning', icon: 'education', description: 'Modern learning platforms and EdTech solutions.' },
  { name: 'Startups & SMBs', icon: 'startup', description: 'Affordable, scalable technology for growing businesses.' },
  { name: 'Large Enterprises', icon: 'enterprise', description: 'Enterprise-grade solutions for complex organizations.' },
]
...
export const testimonials = [
  {
    quote: 'SpringVox transformed our digital infrastructure. Their AI solutions helped us reduce operational costs by 35% while improving service delivery times.',
    author: 'Sarah Chen',
